...
room4 = Room.create(description: "This room has a window too. 'Of course there's a window.' you think to yourself. The instructors would want to watch you run through the test. As you look at the floor you see a broken key.", north: nil, east: nil, south: nil, west: 2, level: level)
