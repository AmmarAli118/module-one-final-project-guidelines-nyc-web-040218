...
room3 = Room.create(description: "This room looks the same as the last room but with doors to the north, south, east and west. And is that a... sledgehammer on the floor?", north: nil, east: 2, south: nil, west: nil, level: level)

room4 = Room.create(description: "This room looks the same as the last room but with doors to the north, south, east and west. And is that a... sledgehammer on the floor?", north: nil, east: nil, south: nil, west: 2, level: level)

room5 = Room.create(description: "This room looks the same as the last room but with doors to the north, south, east and west. And is that a... sledgehammer on the floor?", north: 2, east: nil, south: nil, west: nil, level: level)
